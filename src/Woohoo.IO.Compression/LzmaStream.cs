...
using Woohoo.IO.Compression.Internal.LZ;
using Woohoo.IO.Compression.Internal.LZMA;
...
public sealed class LzmaStream : Stream
{
    ...
    private readonly LzOutWindow outWindow = new LzOutWindow();
    ...
    public override long Seek(long offset, SeekOrigin origin)
    {
        ...
        while (sizeToGo > 0)
        {
            ...
            this.ReadExactly(tmpBuff, 0, sizenow);
            sizeToGo -= sizenow;
        }
