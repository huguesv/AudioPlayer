namespace Woohoo.IO.Compression.Internal.LZ;

internal sealed class LzBinTree : LzInWindow
{
    ...
    public uint GetMatches(uint[] distances)
    {
        ...
        if (HASH_ARRAY)
        {
            uint temp = Utils.CRC.CRC32Lookup[_bufferBase[cur]] ^ _bufferBase[cur + 1];
    ...
    void Normalize()
    {
        ...
        this.NormalizeLinks(_son, _cyclicBufferSize * 2, subValue);
        this.NormalizeLinks(_hash, _hashSizeSum, subValue);
