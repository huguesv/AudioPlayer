...
public class SubStream : Stream
{
    ...
    public SubStream(Stream innerStream, long startPosition, long length)
    {
        ...
        ArgumentOutOfRangeException.ThrowIfLessThan(startPosition, 0);
        ArgumentOutOfRangeException.ThrowIfLessThan(length, 0);
        ArgumentOutOfRangeException.ThrowIfGreaterThan(startPosition + length, innerStream.Length);
    ...
    public override long Position
    {
        ...
        set
        {
            ...
            ArgumentOutOfRangeException.ThrowIfGreaterThan(value, this.length);
