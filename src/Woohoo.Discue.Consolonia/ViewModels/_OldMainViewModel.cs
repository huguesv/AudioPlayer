...
public partial class _OldMainViewModel : ObservableObject
{
    ...
    public _OldMainViewModel(IFilePickerService filePickerService, IThemeService themeService, IMetadataProvider? metadataProvider, ILyricsProvider? lyricsProvider)
    {
